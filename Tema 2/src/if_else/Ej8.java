...
public class Ej8 {
	...
	public static void main(String[] args) {
		...
		double numero; // Creamos la variable para almacenar el numero introducido
		System.out.println("Introduce un número entre 0 y 10:"); // Pide el numero
		numero = scanner.nextDouble(); // Lee el teclado
		...
		if (numero < 0 || numero > 10) { // Comprueba que el numero esta dentro del rango establecido
			...
			} else if (numero >= 7 && numero < 9) { // Comprueba si es notable
				System.out.println("Notable");
			} else if (numero >= 6 && numero < 7) { // Comprueba si es bien
				System.out.println("Bien");
			} else if (numero >= 5 && numero < 6) { // Comprueba si es suficiente
